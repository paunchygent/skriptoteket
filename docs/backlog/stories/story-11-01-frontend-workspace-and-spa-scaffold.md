...
epic: "EPIC-11"
acceptance_criteria:
  - "Given the repo is set up, when running the frontend install and quality scripts, then the SPA and UI package build, lint, and typecheck successfully without Tailwind dependencies"
