...
acceptance_criteria:
  - "Given a teacher completes a seating export with changed assignments, when the export succeeds, then the system records one eligible seating checkpoint for smart-history use."
