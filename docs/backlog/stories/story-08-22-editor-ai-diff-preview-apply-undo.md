...
- Checkpoint safety: “Apply” must create a labeled checkpoint immediately before applying (e.g. “Before AI apply”) so users can roll back even if the ST-08-22 Undo is no longer applicable after subsequent edits.
