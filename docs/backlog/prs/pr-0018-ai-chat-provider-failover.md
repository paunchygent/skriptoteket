...
acceptance_criteria:
  ...
  - "Backend + SPA tests cover routing + opt-in behavior, and live verification is recorded in `.codex/handoff.md`."
---
...
- Live check: `pdm run dev-local` (record manual verification in `.codex/handoff.md`)
