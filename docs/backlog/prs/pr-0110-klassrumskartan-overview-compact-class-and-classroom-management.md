...
acceptance_criteria:
  ...
  - "The overview exposes the active class, class edit flow, class creation, and class switching without long expanded management lists."
  ...
  - "Delete remains an explicit adjacent action rather than being embedded inside the classroom selector."
...
- Overview surface:
  ...
  - add a classroom panel with selector, compact preview, and explicit actions
...
- Frontend unit/integration:
  ...
  - classroom selector/edit/create/delete actions wire correctly
