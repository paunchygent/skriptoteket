...
acceptance_criteria:
  ...
  - "If any UI/route behavior changes, a live functional check is recorded in `.codex/handoff.md`."
---
...
- [x] **Verification recorded:** exact commands and manual checks are recorded in `.codex/handoff.md`.
