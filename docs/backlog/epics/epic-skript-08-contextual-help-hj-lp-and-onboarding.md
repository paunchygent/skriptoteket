...
closeout_review:
  record: inline
  status: not_started
outcome: Users understand what they can do on each page via concise, Swedish, context-aware
  help without external documentation.
retired_ids:
- EPIC-08
---
...
- Klassrumskartan planner help now ships through a guide-generated topic source with mode-aware context
