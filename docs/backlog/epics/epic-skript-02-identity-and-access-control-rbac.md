...
closeout_review:
  record: inline
  status: not_started
outcome: Users can authenticate, self-register, verify email, recover local-account
  access, manage their profiles, and role checks reliably gate contributor/admin/superuser
  capabilities.
retired_ids:
- EPIC-02
---
