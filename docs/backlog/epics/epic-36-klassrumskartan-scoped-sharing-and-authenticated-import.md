...
owners: "agents"
created: 2026-05-01
outcome: "Klassrumskartan share links and current-link management are scoped by roster fingerprints, with seating prepared to add classroom context, while later authenticated import/discovery focuses on reusable roster and classroom-template assets rather than short-lived grouping or seating snapshot state."
dependencies: ["EPIC-24", "EPIC-26", "EPIC-32", "ADR-0079", "ADR-0084"]
---
...
- Keep public guest sharing intentionally narrower:
  ...
  - browser-held revoke metadata may use class-scoped keys where feasible, but
    public mode must stay inside the accepted `ADR-0084` exception.
...
- Replacing the existing `ST-26-06` immutable share-page contract.
...
- [Klassrumskartan product direction](../../reference/ref-group-seating-studio-product-direction-2026-03-21.md)
- [Scoped sharing reference](../../reference/ref-klassrumskartan-scoped-sharing-and-import-direction-2026-05-01.md)
- [EPIC-24: Klassrumskartan fundamentals recovery](epic-24-group-seating-studio-slice-2.md)
- [EPIC-26: explicit exports and share links](epic-26-klassrumskartan-explicit-exports-and-class-list-import.md)
- [EPIC-32: public curated-app access foundation](epic-32-public-curated-app-access-foundation-and-klassrumskartan-demo.md)
- [ST-26-06: shareable HTML/CSS export links](../stories/story-26-06-klassrumskartan-shareable-html-css-export-links.md)
