---
type: runbook
id: RUN-SKRIPT-runbook-observability-metrics-prometheus
...
summary: Metrics and health endpoints exposed by Skriptoteket, plus Prometheus scrape
  guidance.
system: skriptoteket
---
...
The source does not state separate stop conditions.
