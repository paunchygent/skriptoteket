...
### Source: 2) Draft placeholder slug
...
### Source: 3) Pre-publish slug mutability (admin-only)
...
### Source: 4) Publish-time slug requirements
...
### Source: 5) Post-publish immutability (v0.1)
