...
type: adr
id: ADR-SKRIPT-0073
title: Competitive browser games as bespoke curated apps with lightweight global high-score
  support
...
### Source: 1. Competitive games are bespoke curated apps
...
### Source: 2. The browser runtime owns live simulation
...
### Source: 3. The backend owns durable competition state
...
### Source: 4. Introduce a shared `competitive_play` bounded context
...
### Source: 5. Scope leaderboard entries by app and ruleset
...
### Source: 6. Use a lightweight server-owned submission flow
...
### Source: 8. Identity and public display
