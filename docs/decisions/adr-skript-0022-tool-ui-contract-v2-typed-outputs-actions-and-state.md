...
### Source: Compatibility with ADR-0015 (contract v1)
...
### Source: 1) Extend runner `result.json` to contract version 2
...
### Source: 1a) Concrete `result.json` schema (v2)
...
### Source: Output kinds (initial allowlist)
...
### Source: `next_actions` schema (constrained, platform-rendered)
...
### Source: 2) All interactivity is platform-rendered (no arbitrary JS)
...
### Source: 3) Normalization is deterministic and policy-driven
