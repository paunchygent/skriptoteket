---
type: reference
id: REF-SKRIPT-GENERAL-reference-flunk-out-frenzy-physical-rail-architect-direction-2026-04-04
...
summary: 'Reference: Flunk-Out Frenzy physical rail architect direction (2026-04-04)'
---
...
### Source: Architectural direction
...
### Source: 1. Recommended physical carrier model
...
### Source: 2. Recommended authored / compiler / runtime split



### Source: Authored spec
...
### Source: Runtime observation / classification
...
### Source: 3. Acceptable vs forbidden heuristics
...
### Source: 4. Rapier-specific implementation risks
...
### Source: Default solver budget is modest
...
### Source: Do not model the carrier as a thin mesh shortcut
...
### Source: Kinematic plunger motion should follow Rapier's interaction model
...
### Source: World ownership is the core architectural risk
...
### Source: 5. Staged implementation strategy
...
### Source: 6. Verification guidance that keeps PR-0214 strict
...
### Source: 7. Candidate recommendation judgments



### Source: 1. Do not physicalize the current `travelRoutes`; demote them to observation / proof spines only.
...
### Source: 2. Add explicit carrier types instead of overloading `guideRails`.
...
### Source: 3. Convert the current overhead donor wireforms into real colliders.
...
### Source: 4. Keep only terminal `handoffVelocity` as a production mechanics heuristic.
...
### Source: 5. Forbid all route-start snaps, per-step transport writes, speed floors, and hidden seam nudges in production.
...
### Source: 6. Keep the separate launcher Rapier 3D seam only if it owns the entire elevated route through one late board handoff.
