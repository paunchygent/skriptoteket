---
type: reference
id: REF-SKRIPT-DECISIONS-review-workflow-for-backlog-items-and-retained-decision-records
...
The source does not provide a separate outcome and purpose section; no additional outcome and purpose is recorded.

## Decision Boundary

The source does not provide a separate decision boundary section; no additional decision boundary is recorded.

## Open Questions And Assumptions

The source does not provide a separate open questions and assumptions section; no additional open questions and assumptions is recorded.

## Closure State

The source does not provide a separate closure state section; no additional closure state is recorded.

### Source: When reviews are required
...
### Source: Frontmatter expectations
