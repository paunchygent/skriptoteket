---
type: reference
id: REF-runner-tool-code-modularization-map
...
## Direction A — shared runner libraries (platform-owned)
...
## Direction B — multi-file tool code bundles (tool-owned, per version)
...
## How Directions A and B fit together (recommended framing)
...
## Candidate ADR/PRD breakdown (for later)
