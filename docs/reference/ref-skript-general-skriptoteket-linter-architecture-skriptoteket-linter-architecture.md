---
type: reference
id: REF-SKRIPT-GENERAL-skriptoteket-linter-architecture
...
retired_ids:
- REF-linter-architecture
summary: Skriptoteket Linter Architecture
---
...
### Source: 1. The Linter Context (Single Source of Truth)
...
### Source: 2. Variable Tracking (Data Flow)
...
### Source: 4. Syntax Errors (Default Rule)
...
### Source: 5. Quick Fixes (Diagnostic Actions)
...
### Source: Phase 1: Infrastructure & Harness
...
### Source: Phase 2: Variable Tracking
