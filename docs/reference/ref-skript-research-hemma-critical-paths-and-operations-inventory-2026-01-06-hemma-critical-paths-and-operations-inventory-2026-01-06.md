---
type: reference
id: REF-SKRIPT-RESEARCH-hemma-critical-paths-and-operations-inventory-2026-01-06
...
retired_ids:
- REF-hemma-critical-paths-2026-01-06
summary: Hemma critical paths and operations inventory (2026-01-06)
---
...
The source does not provide a separate evidence and sources section; no additional evidence and sources is recorded.

## Findings And Interpretation

The source does not provide a separate findings and interpretation section; no additional findings and interpretation is recorded.

## Evidence Gaps And Follow-Up

The source does not provide a separate evidence gaps and follow-up section; no additional evidence gaps and follow-up is recorded.
...
### Source: Power Rail Monitoring (PSU)
...
### Source: UFW rules (snapshot: 2026-01-06)
...
### Source: Shared PostgreSQL (production)
...
### Source: Core systemd services (snapshot)
...
### Source: Crash capture (kdump) (current)
...
### Source: CLI / Ops Tooling (installed)
...
### Source: Restore Checklist (minimum)
...
### Source: Autoinstall boot (SSH-from-start)
