---
type: reference
id: REF-SKRIPT-GENERAL-reference-competitive-games-curated-apps-and-flunk-out-frenzy
...
summary: 'Reference: Competitive games curated apps and Flunk-Out Frenzy'
---
...
### Source: Suggested backend API shape
...
### Source: High-score support planned from day one
...
### Source: Explicit non-goals for this reference
...
### Source: Recommended family model
...
### Source: Flunk-Out Frenzy frontend boundary
...
### Source: Flunk-Out Frenzy stack recommendation
...
### Source: Identity and display rules
