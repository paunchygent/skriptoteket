---
type: reference
id: REF-SKRIPT-GENERAL-epic-04-pre-implementation-architecture-review
...
retired_ids:
- REF-architectural-review-epic-04
summary: EPIC-04 Pre-Implementation Architecture Review
---
...
4. **Web router rule compliance**: `.codex/rules/040-fastapi-blueprint.md` forbids `from __future__ import annotations` in router modules; `src/skriptoteket/web/router.py` currently includes it and should be corrected when you touch routing for EPIC-04.
