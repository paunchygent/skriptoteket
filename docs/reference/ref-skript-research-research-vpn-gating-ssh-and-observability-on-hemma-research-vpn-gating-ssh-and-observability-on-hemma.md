---
type: reference
id: REF-SKRIPT-RESEARCH-research-vpn-gating-ssh-and-observability-on-hemma
...
retired_ids:
- REF-security-perimeter-vpn-gating-ssh-and-observability
summary: 'Research: VPN gating SSH and observability on hemma'
---
...
This document supports **ADR-SKRIPT-0053** by explaining VPN gating options and what they mean in practice for:
...
### Source: Current baseline (already implemented)
...
### Source: Option 2: WireGuard (self-hosted)
...
### Source: A) SSH behind VPN: staged rollout (recommended)
...
### Source: B) Observability behind VPN: what “remote browser access” means
...
### Source: Recommendation (for decision)
...
### Source: Open questions to answer in review
