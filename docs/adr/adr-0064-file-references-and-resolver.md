...
created: 2026-01-20
updated: 2026-01-20
links: ["EPIC-19", "ADR-0039", "ADR-0059", "ADR-0063"]
---
...
### 1) `FileRef` is a stable, opaque string identifier (Option A)
...
### 2) The platform resolves refs and stages bytes into `/work/input/`
...
### 3) Uploads are session refs immediately (single mental model)
...
### 4) Resolver responsibilities (protocol-level)
