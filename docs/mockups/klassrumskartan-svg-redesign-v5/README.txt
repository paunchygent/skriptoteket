Klassrumskartan SVG Redesign v5 — "Arkitektens Ritning"
...
- Fixture fills — tavla, kateder, windows get subtle navy fill (8 %) for hierarchy
- Stroke-only seats — no paper fill; occupied seats use solid stroke, empty seats use dashed stroke
...
| Hero dead space    | Large empty areas            | Dimension marks fill the margins            |
...
- Label consistency: All SVGs use "TAVLA" (Swedish) instead of mixing with "WHITEBOARD"
- No background grid: Clean canvas, dimension marks carry the architectural feel alone
