...
3. **.codex/rules/045-huleedu-design-system.md** — **PRIMARY REFERENCE**: design tokens, button hierarchy, component classes
4. **.codex/rules/040-fastapi-blueprint.md** — Web layer patterns, HTMX endpoint conventions
...
2. **Update handoff** in `.codex/handoff.md` with:
