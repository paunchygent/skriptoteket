...
class ClassroomPlannerShareArtifactModel(Base):
    ...
    guest_snapshot_fingerprint: Mapped[str | None] = mapped_column(String(96), nullable=True)
    client_operation_id: Mapped[str | None] = mapped_column(String(128), nullable=True)
    revoke_secret_hash: Mapped[str | None] = mapped_column(String(96), nullable=True)
