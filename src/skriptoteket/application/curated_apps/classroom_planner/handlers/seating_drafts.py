"""Seating-specific draft lifecycle handlers for the classroom planner.

This module owns seating-only lifecycle transitions that should not be folded
into the generic resolve flow. It keeps explicit "new seating draft" behavior
separate from ordinary draft resolution so the frontend can request a fresh
room-bound seating workspace without smuggling lifecycle semantics through the
UI.
"""
...
class CreateSeatingDraftHandler:
    """Create a brand-new seating draft for one class and classroom."""
