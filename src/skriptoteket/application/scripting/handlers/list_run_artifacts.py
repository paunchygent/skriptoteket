...
from skriptoteket.protocols.interactive_tools import ListArtifactsHandlerProtocol
...
class ListArtifactsHandler(ListArtifactsHandlerProtocol):
    def __init__(
        self,
        *,
    ...
    async def handle(self, *, actor: User, query: ListArtifactsQuery) -> ListArtifactsResult:
