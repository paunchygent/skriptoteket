...
class ResolveSandboxSettingsHandler(ResolveSandboxSettingsHandlerProtocol):
    def __init__(
        self,
        *,
    ...
    async def handle(
        ...
        *,
        ...
        settings_schema = normalize_tool_settings_schema(
            settings_schema=query.settings_schema,
        )
        ...
        async with self._uow:
            ...
            settings_state = await self._settings_service.resolve_sandbox_settings(
                tool_id=version.tool_id,
                user_id=actor.id,
        ...
        return ResolveSandboxSettingsResult(settings=settings_state)
