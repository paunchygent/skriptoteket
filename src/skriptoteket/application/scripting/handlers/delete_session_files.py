...
from skriptoteket.protocols.interactive_tools import DeleteSessionFilesHandlerProtocol
from skriptoteket.protocols.session_files import SessionFileStorageProtocol
from skriptoteket.protocols.uow import UnitOfWorkProtocol


class DeleteSessionFilesHandler(DeleteSessionFilesHandlerProtocol):
    def __init__(
        self,
        *,
    ...
    async def handle(
        ...
        *,
        ...
        deleted = await self._session_files.delete_files(
        ...
        return DeleteSessionFilesResult(
            tool_id=command.tool_id,
            context=context,
            deleted=deleted,
        )
