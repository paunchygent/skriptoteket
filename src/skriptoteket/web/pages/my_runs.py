"""User run history routes (legacy).

ST-11-08 replaces the run history pages with SPA views, but legacy SSR pages still
link to `/my-runs/{run_id}/artifacts/{artifact_id}` for downloads.
"""
