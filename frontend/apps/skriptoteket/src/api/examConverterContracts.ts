...
type DigiExamAnswerKeyReviewProvenanceDetail = { candidate_id: string; candidate_payload_digest: string; prompt_template_version: string; provider_profile_id: string; schema_name: string; schema_version: string; validation_state: "valid" };
