...
<template>
  ...
  >
    <div
      class="flex flex-col gap-2 border-b border-navy/20 pb-2 md:flex-row md:items-start md:justify-between"
      :class="props.compact ? 'planner-room-canvas-compact-toolbar' : ''"
    >
