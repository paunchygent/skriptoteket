...
<p>Du behöver inget klassrum för att göra grupper. Det gör att du kan använda funktionen direkt när du bara vill dela in klassen för ett grupparbete.</p>
<p>Har du redan sparat regler under <strong>Regler</strong> kan du slå på <strong>Smart</strong> här också:</p>
<ul><li><strong>Håll isär</strong> gör att elever inte hamnar i samma grupp.</li><li><strong>Håll nära</strong> gör att elever oftare hamnar i samma grupp.</li></ul>
<p>Du kan dra elever mellan grupper, klicka <strong>Börja om</strong> eller slumpa igen. Har du historik på försöker appen också variera grupperna över tid.</p>
<p>Klicka <strong>Exportera</strong> när du är nöjd:</p>
<ul><li><strong>Excel</strong> (förvalt) -- du får en presentationsflik och en redigeringsflik.</li><li><strong>PDF A4 stående</strong> -- om du vill skriva ut eller visa grupperna.</li></ul>
<p>Behöver du justera klassen kan du göra det direkt från menyn här också.</p>`,
