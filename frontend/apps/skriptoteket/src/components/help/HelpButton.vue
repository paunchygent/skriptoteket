...
<template>
  <button
    type="button"
    class="px-2 py-1 text-xs font-semibold uppercase tracking-wide text-navy hover:text-action transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-action/40"
