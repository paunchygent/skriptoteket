...
- EPIC-24 next planned implementation chain is:
  - `PR-0115` is locally implemented and verified; next natural step is commit/review/merge and then move to `PR-0116`
  - only stay inside `PR-0115` for follow-up polish if review or manual QA finds a regression in the new route-shell modules
