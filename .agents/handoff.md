...
- Completed: `ST-24-01` (`PR-0079` to `PR-0081`) and `ST-24-05` (`PR-0082` to `PR-0085`) are implemented locally; `PR-0086` and `PR-0087` are on `main`; `PR-0088` and `PR-0089` are implemented locally for `ST-24-02`, including roomless seating drafts and the shared fixed top-panel selector.
...
- Package `PR-0088` and `PR-0089` together cleanly, then continue to `ST-24-03`.
