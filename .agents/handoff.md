...
- Completed: `PR-0120`, `PR-0121`, `PR-0122`, `PR-0123`, `PR-0124`, `PR-0125`, `PR-0126`, `PR-0137`, `PR-0138`, `PR-0139`, `PR-0140`, `PR-0142`, `PR-0143`, `PR-0145`, `PR-0146`, `PR-0147`, `PR-0148`, `PR-0149`, `PR-0150`, `PR-0151`, `PR-0152`, `PR-0153`, `PR-0154`, `PR-0155`, `PR-0157`, `PR-0161`, `PR-0162`, `PR-0163`, `PR-0164`, `PR-0165`, `PR-0166`, `PR-0169`, `PR-0170`, `PR-0171`, `PR-0173`, `PR-0174`, `PR-0176`, `PR-0177`, `PR-0179`, `PR-0180`, `PR-0181`
## Status
...
- 2026-03-30 `PR-0167` live toolbar cutover verification:
  - `pdm run fe-test -- --run src/views/apps/useSmartGroupingRun.spec.ts src/views/apps/useClassroomState.spec.ts src/composables/editor/linter/headlessLinterHarness.spec.ts src/views/apps/components/PlannerGroupingWorkspacePane.export.spec.ts src/views/apps/components/PlannerSeatingWorkspacePane.export.spec.ts src/views/apps/components/PlannerWorkspaceShell.spec.ts`; `pdm run pytest tests/unit/application/apps/classroom_planner/test_smart_grouping.py`; `pdm run fe-type-check`; `pdm run docs-validate`; `pdm run python -m scripts.playwright_pr_0167_smart_grouping_cutover_check --base-url http://127.0.0.1:5173`
  - `fe-type-check` is green again after fixing `frontend/apps/skriptoteket/src/composables/editor/pythonLezer/syntaxErrors.ts`; refreshed PNG artifacts are under `.artifacts/pr-0167-toolbar-check/` (`grouping-toolbar-live.png`, `grouping-settings-drawer-live.png`, `grouping-no-history-block.png`, `grouping-smart-success.png`, `seating-toolbar-live.png`, `seating-settings-drawer-live.png`, `seating-overflow-live.png`) and the seating overflow menu now overlays the toolbar instead of creating an inner scroll lane
